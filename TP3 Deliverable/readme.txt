 READ ME:
        ...
        You can view you events
        in a day view or a week view.
...
How to Run:
	The user should run the Smart_Planner_ApplicationV2.py
	file to use the application.

Libraries:
	The libraries used for this project was cmu_112_graphics and
	datetime.

Shortcuts:
	There are no shortcuts in this project.
